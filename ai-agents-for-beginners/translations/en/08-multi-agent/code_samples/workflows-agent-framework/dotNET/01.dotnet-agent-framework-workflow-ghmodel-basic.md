...
2. Deploy a model (for example, `gpt-4.1-mini`) and note the deployment name
...
```mermaid
graph TD
    A[Constructor de flujo de trabajo] --> B[Registro de agentes]
    B --> C[Motor de ejecución de flujo de trabajo]
