...
![Agenti AI per Principianti](../../translated_images/it/repo-thumbnailv3.917487e234b90100.webp)
...
[![Richieste di Pull GitHub](https://img.shields.io/github/issues-pr/microsoft/ai-agents-for-beginners.svg)](https://GitHub.com/microsoft/ai-agents-for-beginners/pulls/?WT.mc_id=academic-105485-koreyst)
...
**Se desideri supportare ulteriori lingue di traduzione, sono elencate [qui](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md).**
...
[![Discord Microsoft Foundry](https://dcbadge.limes.pink/api/server/ATgtXmAS5D)](https://discord.com/invite/ATgtXmAS5D)


## 🌱 Iniziare

Questo corso comprende lezioni che trattano le basi della costruzione di Agenti AI. Ogni lezione copre un argomento specifico, quindi inizia dove preferisci!

C'è supporto multilingue per questo corso. Vai alle nostre [lingue disponibili qui](#-multi-language-support). 

Se è la tua prima volta che costruisci con modelli di AI Generativa, dai un'occhiata al nostro corso [Generative AI Per Principianti](https://aka.ms/genai-beginners), che include 21 lezioni sulla costruzione con GenAI.
...
Se rimani bloccato o hai domande sulla costruzione di Agenti AI, unisciti al nostro canale Discord dedicato su [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).
...
Gli esempi di codice in questi esercizi utilizzano Microsoft Agent Framework con Microsoft Foundry Agent Service V2:
...
Alcuni esempi di codice supportano anche provider alternativi compatibili con OpenAI come [MiniMax](https://platform.minimaxi.com/), che offre modelli a contesto esteso (fino a 204K token). Consulta la sezione [Configurazione del Corso](./00-course-setup/README.md) per i dettagli di configurazione.

Per maggiori informazioni sull'esecuzione del codice per questo corso, vai a [Configurazione del Corso](./00-course-setup/README.md).
...
- Esempi di codice Python che utilizzano Microsoft Agent Framework con Microsoft Foundry
...
| Esplorazione dei Framework Agentic            | [Link](./02-explore-agentic-frameworks/README.md)  | [Video](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Comprendere i Pattern di Progettazione Agentic | [Link](./03-agentic-design-patterns/README.md)     | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Pattern di Progettazione Metacognitivo           | [Link](./09-metacognition/README.md)               | [Video](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Uso di Protocolli Agenti (MCP, A2A e NLWeb)     | [Link](./11-agentic-protocols/README.md)           | [Video](https://youtu.be/X-Dh9R3Opn8)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Gestione della Memoria Agente                     | [Link](./13-agent-memory/README.md)     |      [Video](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| Esplorazione del Microsoft Agent Framework        | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Creazione di Agenti per Uso del Computer (CUA)    | [Link](./15-browser-use/README.md)     |                                                            | [Link](https://docs.browser-use.com/examples/templates/playwright-integration)         |
| Distribuzione di Agenti Scalabili                  | [Link](./16-deploying-scalable-agents/README.md) |                                                    | [Link](https://learn.microsoft.com/azure/ai-foundry/agents/overview)                   |
| Creazione di Agenti AI Locali                       | [Link](./17-creating-local-ai-agents/README.md)  |                                                    | [Link](https://learn.microsoft.com/azure/ai-foundry/foundry-local/)                    |
...
### Serie Copilot
[![Copilot per Programmazione Coppia AI](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
Accordo di Licenza del Contributore (CLA) che dichiara che hai il diritto e che effettivamente ci concedi
...
un CLA e decorerà la PR in modo appropriato (es. controllo dello stato, commento). Segui semplicemente le istruzioni
...
Questo progetto può contenere marchi o loghi di progetti, prodotti o servizi. L'uso autorizzato dei marchi Microsoft
o dei loghi è soggetto e deve seguire
[Linee Guida per i Marchi e Brand di Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
...
Qualsiasi uso di marchi o loghi di terze parti è soggetto alle politiche di quei terzi.
