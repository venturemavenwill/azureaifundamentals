...
This notebook demonstrates **លំនាំផ្ញើការងារជាតាមលក្ខខណ្ឌ** using Azure AI Foundry and the Microsoft Agent Framework for .NET. You'll learn how to build sophisticated, decision-driven workflows that intelligently route processing based on AI analysis, business rules, and dynamic conditions for enterprise-grade automation.
...
```mermaid
graph TD
    A[បញ្ចូល: សេចក្តីសង្ខេបមាតិកា] --> B[អ្នកអនុវត្តព្រាង]
    B --> C[អ្នកអនុវត្តពិនិត្យមាតិកា]
    C --> D{សេចក្តីសម្រេចពិនិត្យ}
    
    D -->|យល់ព្រម - អនុម័ត| E[អ្នកអនុវត្តផ្សព្វផ្សាយ]
    D -->|ទេ - បដិសេធ| F[អ្នកអនុវត្តផ្ញើសម្រាប់ពិនិត្យ]
    
    E --> G[រក្សាទុកជាឯកសារ Markdown]
    F --> H[ជូនដំណឹងសម្រាប់ការកែសម្រួល]
    
    I[អាស៊ឺរ អេអាយ ហ្វោនដ្រី] --> B
    I --> C
    I --> E
...
**ការមិនទទួលខុសត្រូវ**:
ឯកសារនេះត្រូវបានបកប្រែដោយប្រើសេវាកម្មបកប្រែ AI [Co-op Translator](https://github.com/Azure/co-op-translator)។ ខណៈពេលដែលយើងខិតខំនឿនសម្រាប់ភាពត្រឹមត្រូវ សូមយល់ឱ្យដឹងថាការបកប្រែដោយស្វ័យប្រវត្តិអាចមានកំហុស ឬភាពមិនត្រឹមត្រូវបាន។ ឯកសារដើមដែលសរសេរជាភាសាមាតុភូមិគួរត្រូវបានចាត់ទុកជា​ប្រភពដែលអាចទុកចិត្តបាន។ សម្រាប់ព័ត៌មានសំខាន់ៗ យើងណែនាំឱ្យប្រើការបកប្រែដោយអ្នកបកប្រែវិជ្ជាជីវៈ។ យើងមិនទទួលខុសត្រូវចំពោះការយល់ច្រឡំ ឬការបកស្រាយខុសណាមួយដែលកើតឡើងពីការប្រើប្រាស់ការបកប្រែនេះទេ។
