...
[![Pedidos de Pull Bem-vindos](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com?WT.mc_id=academic-105485-koreyst)

### 🌐 Suporte Multi-Idioma

#### Suportado via Ação GitHub (Automatizado e Sempre Atualizado)
...
[![Acompanhantes GitHub](https://img.shields.io/github/watchers/microsoft/ai-agents-for-beginners.svg?style=social&label=Watch)](https://GitHub.com/microsoft/ai-agents-for-beginners/watchers/?WT.mc_id=academic-105485-koreyst)
...
Este curso tem lições que cobrem os fundamentos da construção de Agentes de IA. Cada lição cobre o seu próprio tema, por isso comece por onde quiser!

Existe suporte multi-idioma para este curso. Consulte as [línguas disponíveis aqui](#-multi-language-support). 

Se é a sua primeira vez a construir com modelos de IA Generativa, veja o nosso curso [IA Generativa para Iniciantes](https://aka.ms/genai-beginners), que inclui 21 lições sobre como construir com GenAI.

Não se esqueça de [guardar com estrela (🌟) este repositório](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) e [fazer fork deste repositório](https://github.com/microsoft/ai-agents-for-beginners/fork) para executar o código.

### Conheça Outros Alunos, Tire as Suas Dúvidas

Se ficar bloqueado ou tiver dúvidas sobre como construir Agentes de IA, junte-se ao nosso canal dedicado no Discord no [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).
...
Alguns exemplos de código também suportam fornecedores alternativos compatíveis com OpenAI, como [MiniMax](https://platform.minimaxi.com/), que oferece modelos de contexto extenso (até 204K tokens). Veja os detalhes de configuração no [Course Setup](./00-course-setup/README.md).

Para mais informações sobre como executar o código deste curso, consulte o [Course Setup](./00-course-setup/README.md).

## 🙏 Quer ajudar?

Tem sugestões ou encontrou erros de ortografia ou de código? [Abra uma issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) ou [Crie um pedido de pull](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)



## 📂 Cada lição inclui

- Uma lição por escrito localizada no README e um vídeo curto
...
| Exploração de Frameworks de IA Agentes       | [Link](./02-explore-agentic-frameworks/README.md)  | [Vídeo](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Compreender Padrões de Design de IA Agentes  | [Link](./03-agentic-design-patterns/README.md)     | [Vídeo](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Agente RAG                                   | [Link](./05-agentic-rag/README.md)                 | [Vídeo](https://youtu.be/WcjAARvdL7I?si=gKPWsQpKiIlDH9A3)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Construir Agentes de IA Fiáveis               | [Link](./06-building-trustworthy-agents/README.md) | [Vídeo](https://youtu.be/iZKkMEGBCUQ?si=jZjpiMnGFOE9L8OK ) | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Uso de Protocolos Agénticos (MCP, A2A e NLWeb) | [Link](./11-agentic-protocols/README.md)           | [Vídeo](https://youtu.be/X-Dh9R3Opn8)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Gestão de Memória Agéntica                  | [Link](./13-agent-memory/README.md)     |      [Vídeo](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| Exploração do Microsoft Agent Framework     | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Construção de Agentes de Uso de Computador (CUA) | [Link](./15-browser-use/README.md)     |                                                            | [Link](https://docs.browser-use.com/examples/templates/playwright-integration)         |
| Implementação de Agentes Escaláveis          | Em Breve                            |                                                            |                                                                                        |
| Criação de Agentes Locais de IA              | Em Breve                               |                                                            |                                                                                        |
| Segurança em Agentes de IA                   | Em Breve                               |                                                            |                                                                                        |
...
Obrigado a [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) por contribuir com importantes exemplos de código que demonstram Agentic RAG.

## Contribuições

Este projeto aceita contribuições e sugestões. A maioria das contribuições requer que aceite um
Acordo de Licença de Contribuidor (CLA) declarando que tem o direito e efetivamente nos concede
os direitos para usar a sua contribuição. Para mais detalhes, visite <https://cla.opensource.microsoft.com>.

Quando enviar um pedido de pull, um bot CLA irá automaticamente determinar se precisa fornecer
um CLA e decorar o PR adequadamente (ex.: verificação de estado, comentário). Basta seguir as instruções
fornecidas pelo bot. Só precisa fazer isso uma vez para todos os repositórios que usam o nosso CLA.
...
Este projeto pode conter marcas comerciais ou logótipos de projetos, produtos ou serviços. O uso autorizado das marcas comerciais
ou logótipos Microsoft está sujeito e deve seguir
[Diretrizes de Marcas e Marca da Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
O uso das marcas comerciais ou logótipos Microsoft em versões modificadas deste projeto não deve causar confusão nem
indicar patrocínio pela Microsoft.
...
Se tiver feedback sobre produtos ou erros enquanto desenvolve, visite:
