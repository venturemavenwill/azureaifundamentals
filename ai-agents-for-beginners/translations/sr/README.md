...
![AI агенти за почетнике](../../translated_images/sr/repo-thumbnailv2.06f4a48036fde647.webp)

## Курс који вас учи свему што треба да знате да почнете са изградњом AI агената
...
[![GitHub питања](https://img.shields.io/github/issues/microsoft/ai-agents-for-beginners.svg)](https://GitHub.com/microsoft/ai-agents-for-beginners/issues/?WT.mc_id=academic-105485-koreyst)
...
[![Добродошли PR-ови](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com?WT.mc_id=academic-105485-koreyst)

### 🌐 Подршка за више језика

#### Подржано преко GitHub Action-а (Аутоматски и увек ажурно)
...
> ```
>
> Ово вам даје све што вам је потребно за комплетирање курса са много бржим преузимањем.
...
[![GitHub посматрачи](https://img.shields.io/github/watchers/microsoft/ai-agents-for-beginners.svg?style=social&label=Watch)](https://GitHub.com/microsoft/ai-agents-for-beginners/watchers/?WT.mc_id=academic-105485-koreyst)
...
[![GitHub звезде](https://img.shields.io/github/stars/microsoft/ai-agents-for-beginners.svg?style=social&label=Star)](https://GitHub.com/microsoft/ai-agents-for-beginners/stargazers/?WT.mc_id=academic-105485-koreyst)
...
Овај курс садржи лекције које покривају основе израде AI агената. Свака лекција покрива одређену тему, па почните где год желите!

Постоји подршка за више језика за овај курс. Погледајте наше [доступне језике овде](#-multi-language-support).

Ако је ово ваш први пут да радите са генеративним AI моделима, погледајте наш курс [Generative AI For Beginners](https://aka.ms/genai-beginners), који укључује 21 лекцију о раду са GenAI.

Не заборавите да [озвездате (🌟) овај репозиторијум](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) и [форкујете овај репозиторијум](https://github.com/microsoft/ai-agents-for-beginners/fork) да бисте покренули код.

### Упознајте друге ученике, добијте одговоре на ваша питања

Ако запнете или имате питања о изградњи AI агената, придружите се нашој посвећеној Discord каналу у [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Шта вам је потребно

Свакa лекцијa у овом курсу укључује примере кода који се могу наћи у фолдеру code_samples. Можете [форковати овај репозиторијум](https://github.com/microsoft/ai-agents-for-beginners/fork) да креирате своју копију.
...
Овај курс користи следеће AI агентске оквире и услуге из Microsoft-а:

- [Microsoft Agent Framework (MAF)](https://aka.ms/ai-agents-beginners/agent-framework)
- [Azure AI Foundry Agent Service V2](https://aka.ms/ai-agents-beginners/ai-agent-service)

Неке примерке кода такође подржавају алтернативне провајдере компатибилне са OpenAI као што је [MiniMax](https://platform.minimaxi.com/), који нуди моделе са великим контекстом (до 204К токена). Погледајте [Course Setup](./00-course-setup/README.md) за детаље конфигурације.

За више информација о покретању кода за овај курс идите на [Course Setup](./00-course-setup/README.md).

## 🙏 Желите да помогнете?

Имате ли сугестије или сте пронашли правописне или код грешке? [Отворите issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) или [Направите pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Увод у AI агенте и примере коришћења агената | [Линк](./01-intro-to-ai-agents/README.md)          | [Видео](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Разумевање AI агентских шаблона дизајна       | [Линк](./03-agentic-design-patterns/README.md)     | [Видео](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Шаблон дизајна коришћења алата               | [Линк](./04-tool-use/README.md)                    | [Видео](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Шаблон дизајна планирања                      | [Линк](./07-planning-design/README.md)             | [Видео](https://youtu.be/kPfJ2BrBCMY?si=6SC_iv_E5-mzucnC)  | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Обрасци дизајна мета-когниције              | [Link](./09-metacognition/README.md)               | [Video](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| AI агенти у производњи                       | [Link](./10-ai-agents-production/README.md)        | [Video](https://youtu.be/l4TP6IyJxmQ?si=31dnhexRo6yLRJDl)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Изградња агената за коришћење компјутера (CUA) | [Link](./15-browser-use/README.md)     |                                                            | [Link](https://docs.browser-use.com/examples/templates/playwright-integration)         |
| Распоређивање скалабилних агената           | Ускоро                               |                                                            |                                                                                        |
| Креирање локалних AI агената                 | Ускоро                                       |                                                            |                                                                                        |
| Заштићивање AI агената                        | [Link](./18-securing-ai-agents/README.md)  |                                                            | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
### Серия Copilot
[![Copilot за парско програмирање AI](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
Захваљујемо [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) за допринос важним примерима кода који демонстрирају Agentic RAG.

## Допринос

Овај пројекат поздравља доприносе и предлоге. Већина доприноса захтева да се сагласите са
Уговором о лиценци за допринос (CLA) у коме изјављујете да имате право и заправо дајете нам
права да користимо ваш допринос. За детаље посетите <https://cla.opensource.microsoft.com>.

Када пошаљете захтев за повлачење, CLA бот аутоматски ће одредити да ли је потребно да доставите
CLA и означиће PR на одговарајући начин (нпр. провера статуса, коментар). Једноставно следите упутства
...
За више информација погледајте [Питања и одговоре о Кодексу понашања](https://opensource.microsoft.com/codeofconduct/faq/) или
...
[Упутства Microsoft-а за заштитне знакове и брендове](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Употреба Microsoft заштитних знакова или логотипа у модификованим верзијама овог пројекта не сме изазивати конфузију нити имплицирати покровитељство Microsoft-а.
Било каква употреба заштитних знакова или логотипа трећих страна подлеже правилима тих трећих страна.
...
Ако имате повратне информације о производу или грешкама током развоја посетите:
