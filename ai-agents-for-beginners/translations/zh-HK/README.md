...
![AI Agents for Beginners](../../translated_images/zh-HK/repo-thumbnailv3.917487e234b90100.webp)

## 一門教你開始建構 AI 代理人所需知道的一切的課程
...
> **想要本地複製嗎？**
>
> 本倉庫包含 50 多種語言的翻譯內容，導致下載大小大幅增加。若要複製而不包含翻譯檔案，請使用稀疏簽出：
>
> **Bash / macOS / Linux:**
> ```bash
...
> ```
>
> 這樣可以讓你以更快的速度下載完成課程所需的所有資源。
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

**如果你希望支援其他翻譯語言，請參考此處列表 [here](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)。**
...
本課程包含了構建 AI 代理人的基礎課程內容。每堂課涵蓋各自主題，你可以從任何地方開始學習！

本課程支援多語言版本。請參考我們的[可用語言列表](#-multi-language-support)。

如果這是你第一次使用生成式 AI 模型構建，請參考我們的[生成式 AI 初學者課程](https://aka.ms/genai-beginners)，其中包含 21 個有關使用 GenAI 的課程。

別忘了[點星標記 (🌟) 本倉庫](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst)並且[派生本倉庫](https://github.com/microsoft/ai-agents-for-beginners/fork)以運行程式碼。

### 與其他學習者交流，解決你的問題

如果你在建立 AI 代理人遇到困難或有任何疑問，歡迎加入我們在 [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord) 的專屬 Discord 頻道。

### 你需要什麼

本課程的每堂課都附有程式碼範例，可在 code_samples 資料夾找到。你可以[派生本倉庫](https://github.com/microsoft/ai-agents-for-beginners/fork)以創建自己的副本。
...
部分程式碼範例也支援其他 OpenAI 相容的提供者，例如提供大上下文模型（最多 204K tokens）的 [MiniMax](https://platform.minimaxi.com/)。請參閱[課程設置](./00-course-setup/README.md)了解配置詳情。

有關運行本課程程式碼的更多資訊，請參見[課程設置](./00-course-setup/README.md)。

## 🙏 想要幫忙嗎？

有建議或發現拼寫或程式碼錯誤嗎？請[提出議題](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst)或[建立拉取請求](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
| <strong>課程</strong>                                     | <strong>內容與程式碼</strong>                                    | <strong>影片</strong>                                                  | <strong>額外學習資源</strong>                                                                     |
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| AI 代理人介紹與使用案例                       | [連結](./01-intro-to-ai-agents/README.md)          | [影片](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [連結](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| 建構可信賴的 AI 代理人                       | [連結](./06-building-trustworthy-agents/README.md) | [影片](https://youtu.be/iZKkMEGBCUQ?si=jZjpiMnGFOE9L8OK ) | [連結](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
感謝 [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) 貢獻重要的示範Agentic RAG的程式碼範例。
...
CLA 並相應標記 PR（例如，狀態檢查、評論）。只需按照機器
人指示操作。您在所有使用我們 CLA 的倉庫中此操作只需執行一次。

本專案採納了 [Microsoft 開源行為準則](https://opensource.microsoft.com/codeofconduct/)。
詳情見 [行為準則常見問題](https://opensource.microsoft.com/codeofconduct/faq/) 或
...
在此專案修改版本中使用 Microsoft 商標或標誌不可造成混淆或暗示 Microsoft 贊助。
任何第三方商標或標誌的使用均需遵守該第三方政策。

## 尋求協助


若您在建立 AI 應用時遇到困難或有任何疑問，歡迎加入：

[![Microsoft Foundry Discord](https://img.shields.io/badge/Discord-Azure_AI_Foundry_Community_Discord-blue?style=for-the-badge&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)

若您在建置過程中有產品反饋或錯誤，請訪問：
