...
**Si deseas tener soporte para idiomas adicionales, están listados [aquí](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Hay soporte multilingüe para este curso. Ve nuestros [idiomas disponibles aquí](#-soporte-multilingüe).

Si es la primera vez que trabajas con modelos de IA generativa, revisa nuestro curso [Generative AI For Beginners](https://aka.ms/genai-beginners), que incluye 21 lecciones para trabajar con GenAI.

No olvides [añadir una estrella (🌟) a este repositorio](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) y [hacer fork de este repositorio](https://github.com/microsoft/ai-agents-for-beginners/fork) para ejecutar el código.

### Conoce a Otros Estudiantes, Resuelve Tus Dudas

Si te quedas atascado o tienes cualquier pregunta sobre la construcción de Agentes de IA, únete a nuestro canal dedicado en Discord en el [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Lo Que Necesitas

Cada lección en este curso incluye ejemplos de código, que se encuentran en la carpeta code_samples. Puedes [hacer fork de este repositorio](https://github.com/microsoft/ai-agents-for-beginners/fork) para crear tu propia copia.

Los ejemplos de código en estos ejercicios utilizan Microsoft Agent Framework con Azure AI Foundry Agent Service V2:

- [Microsoft Foundry](https://aka.ms/ai-agents-beginners/ai-foundry) - Requiere cuenta de Azure
...
Algunos ejemplos de código también soportan proveedores alternativos compatibles con OpenAI como [MiniMax](https://platform.minimaxi.com/), que ofrece modelos con contexto muy amplio (hasta 204K tokens). Consulta la [Configuración del Curso](./00-course-setup/README.md) para detalles de configuración.
...
- Una lección escrita localizada en el README y un video corto
...
| Comprendiendo Patrones de Diseño Agénticos    | [Enlace](./03-agentic-design-patterns/README.md)     | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Enlace](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Patrón de Diseño Multiagente                   | [Enlace](./08-multi-agent/README.md)                 | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Enlace](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Uso de Protocolos Agentes (MCP, A2A y NLWeb) | [Link](./11-agentic-protocols/README.md)           | [Video](https://youtu.be/X-Dh9R3Opn8)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Gestión de Memoria Agente                     | [Link](./13-agent-memory/README.md)     |      [Video](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| Explorando el Marco de Agentes de Microsoft  | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Construcción de Agentes de Uso de Computadora (CUA) | [Link](./15-browser-use/README.md)     |                                                            | [Link](https://docs.browser-use.com/examples/templates/playwright-integration)         |
...
Acuerdo de Licencia de Contribuidor (CLA) declarando que tienes el derecho y de hecho nos otorgas
...
proporcionadas por el bot. Solo tendrás que hacer esto una vez para todos los repositorios que usan nuestro CLA.
...
Este proyecto puede contener marcas registradas o logotipos de proyectos, productos o servicios. El uso autorizado de marcas o logotipos de Microsoft está sujeto a y debe seguir
