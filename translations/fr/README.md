...
![Agents IA pour débutants](../../translated_images/fr/repo-thumbnailv2.06f4a48036fde647.webp)
...
[![Demandes de tirage GitHub](https://img.shields.io/github/issues-pr/microsoft/ai-agents-for-beginners.svg)](https://GitHub.com/microsoft/ai-agents-for-beginners/pulls/?WT.mc_id=academic-105485-koreyst)
...
Ce cours bénéficie d’un support multilingue. Consultez nos [langues disponibles ici](#-multi-language-support).

Si c’est la première fois que vous travaillez avec des modèles IA génératifs, découvrez notre cours [IA générative pour débutants](https://aka.ms/genai-beginners), qui comprend 21 leçons sur la création avec GenAI.
...
Si vous êtes bloqué ou avez des questions sur la création d’Agents IA, rejoignez notre salon Discord dédié dans le [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).
...
Certains exemples de code prennent également en charge des fournisseurs compatibles OpenAI alternatifs comme [MiniMax](https://platform.minimaxi.com/), qui offre des modèles à large contexte (jusqu’à 204K jetons). Voir la [configuration du cours](./00-course-setup/README.md) pour les détails de configuration.
...
Vous avez des suggestions ou vous avez trouvé des erreurs d’orthographe ou de code ? [Signalez un problème](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) ou [Créez une demande de tirage](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
| Explorer les frameworks agentiques            | [Lien](./02-explore-agentic-frameworks/README.md) | [Vidéo](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)    | [Lien](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Agentique RAG                                | [Lien](./05-agentic-rag/README.md)                 | [Vidéo](https://youtu.be/WcjAARvdL7I?si=gKPWsQpKiIlDH9A3)    | [Lien](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Modèle de conception de la métacognition       | [Lien](./09-metacognition/README.md)               | [Vidéo](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Lien](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Exploration du cadre agent Microsoft            | [Lien](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
...
Merci à [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) pour sa contribution importante avec des exemples de code démontrant Agentic RAG.
...
les droits pour utiliser votre contribution. Pour plus de détails, visitez <https://cla.opensource.microsoft.com>.

Lorsque vous soumettez une demande de tirage (pull request), un bot CLA déterminera automatiquement si vous devez fournir
...
marques ou logos Microsoft est soumise et doit suivre
...
L'utilisation des marques ou logos Microsoft dans des versions modifiées de ce projet ne doit pas prêter à confusion ou impliquer un parrainage Microsoft.
Toute utilisation de marques ou logos de tiers est soumise aux politiques de ces tiers.

## Obtenir de l'aide


Si vous êtes bloqué ou avez des questions sur le développement d'applications IA, rejoignez :
...
Si vous souhaitez faire des retours sur le produit ou signalez des erreurs pendant le développement, visitez :

[![Forum des développeurs Microsoft Foundry](https://img.shields.io/badge/GitHub-Azure_AI_Foundry_Developer_Forum-blue?style=for-the-badge&logo=github&color=000000&logoColor=fff)](https://aka.ms/foundry/forum)
