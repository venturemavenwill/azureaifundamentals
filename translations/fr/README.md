...
![AI Agents for Beginners](../../translated_images/fr/repo-thumbnailv2.06f4a48036fde647.webp)
...
Un support multilingue est disponible pour ce cours. Consultez nos [langues disponibles ici](#-multi-language-support).

Si c’est votre première fois à créer avec des modèles d’IA générative, explorez notre cours [Generative AI For Beginners](https://aka.ms/genai-beginners), qui inclut 21 leçons sur la création avec GenAI.
...
Si vous êtes bloqué ou avez des questions sur la création d’agents IA, rejoignez notre chaîne Discord dédiée dans le [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Ce dont vous avez besoin

Chaque leçon de ce cours comprend des exemples de code, qui se trouvent dans le dossier code_samples. Vous pouvez [forker ce dépôt](https://github.com/microsoft/ai-agents-for-beginners/fork) pour créer votre propre copie.
...
Certains exemples de code supportent aussi des fournisseurs alternatifs compatibles OpenAI tels que [MiniMax](https://platform.minimaxi.com/), qui propose des modèles avec un grand contexte (jusqu’à 204K tokens). Consultez la [mise en place du cours](./00-course-setup/README.md) pour les détails de configuration.

Pour plus d’informations sur l’exécution du code pour ce cours, rendez-vous sur la [mise en place du cours](./00-course-setup/README.md).

## 🙏 Vous souhaitez aider ?

Vous avez des suggestions ou avez trouvé des fautes d’orthographe ou de code ? [Ouvrez un problème](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) ou [créez une pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Introduction aux agents IA et cas d’usage des agents | [Lien](./01-intro-to-ai-agents/README.md)           | [Vidéo](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)    | [Lien](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Exploration des cadres agentiques            | [Lien](./02-explore-agentic-frameworks/README.md)   | [Vidéo](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)    | [Lien](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Comprendre les patrons de conception agentique | [Lien](./03-agentic-design-patterns/README.md)      | [Vidéo](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)    | [Lien](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Patron de conception d’utilisation d’outils | [Lien](./04-tool-use/README.md)                     | [Vidéo](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)    | [Lien](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Patron de conception de planification        | [Lien](./07-planning-design/README.md)              | [Vidéo](https://youtu.be/kPfJ2BrBCMY?si=6SC_iv_E5-mzucnC)    | [Lien](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Patron de conception multi-agent             | [Lien](./08-multi-agent/README.md)                  | [Vidéo](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)    | [Lien](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Exploration du Cadre d'Agent Microsoft         | [Lien](./14-microsoft-agent-framework/README.md)   |                                                                   |                                                                                        |
...
| Sécurisation des Agents IA                      | [Lien](./18-securing-ai-agents/README.md)          |                                                                   | [Lien](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Merci à [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) pour avoir contribué des exemples de code importants illustrant Agentic RAG.
...
Lorsque vous soumettez une pull request, un robot CLA déterminera automatiquement si vous devez fournir
...
fournies par le robot. Vous n'aurez besoin de le faire qu'une seule fois pour tous les dépôts utilisant notre CLA.
...
Ce projet peut contenir des marques ou logos de projets, produits ou services. L'utilisation autorisée des marques ou logos Microsoft est soumise et doit suivre
[les Directives sur les Marques & Marques de Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
L'utilisation des marques ou logos Microsoft dans des versions modifiées de ce projet ne doit pas créer de confusion ni impliquer un parrainage par Microsoft.
