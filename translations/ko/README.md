...
![초보자를 위한 AI 에이전트](../../translated_images/ko/repo-thumbnailv2.06f4a48036fde647.webp)
...
#### GitHub Action을 통해 지원 (자동화 및 항상 최신)
...
> ```
>
> 이 방법으로 강좌를 완료하는 데 필요한 모든 것을 훨씬 빠른 다운로드로 얻을 수 있습니다.
...
[![GitHub 별점](https://img.shields.io/github/stars/microsoft/ai-agents-for-beginners.svg?style=social&label=Star)](https://GitHub.com/microsoft/ai-agents-for-beginners/stargazers/?WT.mc_id=academic-105485-koreyst)
...
이 강좌는 AI 에이전트 구축의 기본을 다루는 수업들로 구성되어 있습니다. 각 수업은 자체 주제를 다루므로 원하는 곳부터 시작하세요!
...
AI 에이전트 구축에 관한 문제가 있거나 질문이 있을 경우, [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord)의 전용 Discord 채널에 참여하세요.

### 필요한 것

이 강좌의 각 수업은 코드 예제를 포함하며, code_samples 폴더에서 찾을 수 있습니다. [저장소를 포크](https://github.com/microsoft/ai-agents-for-beginners/fork)하여 본인만의 복사본을 만들 수 있습니다.

이 연습 문제의 코드 예제는 Azure AI Foundry Agent Service V2와 함께 Microsoft Agent Framework를 활용합니다:

- [Microsoft Foundry](https://aka.ms/ai-agents-beginners/ai-foundry) - Azure 계정 필요

이 강좌에서는 Microsoft의 다음 AI 에이전트 프레임워크 및 서비스를 사용합니다:

- [Microsoft Agent Framework (MAF)](https://aka.ms/ai-agents-beginners/agent-framework)
- [Azure AI Foundry Agent Service V2](https://aka.ms/ai-agents-beginners/ai-agent-service)

일부 코드 샘플은 [MiniMax](https://platform.minimaxi.com/)와 같은 OpenAI 호환 대체 공급자도 지원하며, 최대 204K 토큰까지 큰 문맥 모델을 제공합니다. 구성 세부 사항은 [강좌 설정](./00-course-setup/README.md)을 참조하세요.

이 강좌의 코드 실행에 대한 자세한 정보는 [강좌 설정](./00-course-setup/README.md)에서 확인하세요.

## 🙏 도움을 주시겠습니까?

제안 사항이 있거나 철자 또는 코드 오류를 발견하셨나요? [이슈 제기](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) 또는 [풀 리퀘스트 생성](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)을 해주세요.



## 📂 각 수업에 포함된 내용

- README에 작성된 수업과 짧은 영상
- Microsoft Agent Framework와 Azure AI Foundry를 사용한 Python 코드 샘플
- 학습을 계속할 수 있는 추가 리소스 링크


## 🗃️ 수업 목록

| <strong>수업</strong>                                      | **텍스트 및 코드**                                 | <strong>영상</strong>                                                   | **추가 학습**                                                                           |
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| AI 에이전트 소개 및 에이전트 사용 사례       | [링크](./01-intro-to-ai-agents/README.md)           | [영상](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)    | [링크](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)  |
...
중요한 코드 샘플을 기여해주신 [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) 님께 감사드립니다. 이 코드는 Agentic RAG를 구현하는 데 도움이 됩니다.

## 기여 안내

이 프로젝트는 기여 및 제안을 환영합니다. 대부분의 기여는 기여자가 기여한 내용을 사용할 권리를 실제로 가지고 있음을 선언하는  
기여자 라이선스 계약서(CLA)에 동의해야 합니다. 자세한 내용은 <https://cla.opensource.microsoft.com>을 참조하십시오.

풀 리퀘스트를 제출하면 CLA 봇이 자동으로 CLA 제출 여부를 판단하고 적절한 상태 표시(예: 상태 검증, 코멘트)를 추가합니다.  
봇의 지침에 따라 진행하면 됩니다. CLA는 이 프로젝트의 모든 저장소에서 한 번만 제출하면 됩니다.

이 프로젝트는 [Microsoft 오픈 소스 행동 강령](https://opensource.microsoft.com/codeofconduct/)을 채택하고 있습니다. 자세한 내용은  
[행동 강령 FAQ](https://opensource.microsoft.com/codeofconduct/faq/)를 확인하거나 추가 질문 및 의견은 [opencode@microsoft.com](mailto:opencode@microsoft.com)으로 문의하시기 바랍니다.

## 상표

이 프로젝트에는 프로젝트, 제품 또는 서비스의 상표나 로고가 포함될 수 있습니다. Microsoft 상표나 로고를 사용할 경우  
[Microsoft의 상표 및 브랜드 가이드라인](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general)을 따라야 합니다.  
수정된 버전의 이 프로젝트에서 Microsoft 상표나 로고 사용은 혼란을 일으키거나 Microsoft의 후원이라고 오해하게 해서는 안 됩니다.  
제3자 상표나 로고의 사용은 해당 제3자의 정책을 따라야 합니다.

## 도움 받기


AI 앱 구축 중 막히거나 질문이 있으면 아래 커뮤니티에 참여하세요:

[![Microsoft Foundry Discord](https://img.shields.io/badge/Discord-Azure_AI_Foundry_Community_Discord-blue?style=for-the-badge&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)

제품 피드백이나 오류 신고가 있으면 방문하세요:
