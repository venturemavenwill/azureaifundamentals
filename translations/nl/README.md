# AI-agenten voor beginners - Een cursus

![AI Agents for Beginners](../../translated_images/nl/repo-thumbnailv2.06f4a48036fde647.webp)

## Een cursus die alles leert wat je moet weten om te beginnen met het bouwen van AI-agenten
...
>
> Deze repository bevat vertalingen in meer dan 50 talen, wat de downloadgrootte aanzienlijk vergroot. Om te klonen zonder vertalingen, gebruik sparse checkout:
>
> **Bash / macOS / Linux:**
> ```bash
...
**Als je wilt dat er extra vertaaltalen worden ondersteund, staan deze [hier](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md) vermeld**
...
Deze cursus bevat lessen over de basisprincipes van het bouwen van AI-agenten. Elke les behandelt een eigen onderwerp, dus begin waar je maar wilt!

Er is meertalige ondersteuning voor deze cursus. Ga naar onze [beschikbare talen hier](#-multi-language-support).

Als dit je eerste keer is dat je bouwt met Generatieve AI-modellen, bekijk dan onze cursus [Generative AI For Beginners](https://aka.ms/genai-beginners), die 21 lessen omvat over bouwen met GenAI.

Vergeet niet om [deze repo te 'starren' (🌟)](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) en [deze repo te fork-en](https://github.com/microsoft/ai-agents-for-beginners/fork) om de code uit te voeren.

### Ontmoet andere leerlingen, krijg antwoord op je vragen

Als je vastloopt of vragen hebt over het bouwen van AI-agenten, sluit je dan aan bij ons speciale Discord-kanaal in de [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Wat je nodig hebt

Elke les in deze cursus bevat codevoorbeelden, te vinden in de map code_samples. Je kunt [deze repo fork-en](https://github.com/microsoft/ai-agents-for-beginners/fork) om een eigen kopie te maken.

De codevoorbeelden in deze oefeningen maken gebruik van het Microsoft Agent Framework met Azure AI Foundry Agent Service V2:

- [Microsoft Foundry](https://aka.ms/ai-agents-beginners/ai-foundry) - Azure-account vereist

Deze cursus gebruikt de volgende AI-agentframeworks en services van Microsoft:

- [Microsoft Agent Framework (MAF)](https://aka.ms/ai-agents-beginners/agent-framework)
- [Azure AI Foundry Agent Service V2](https://aka.ms/ai-agents-beginners/ai-agent-service)

Sommige codevoorbeelden ondersteunen ook alternatieve OpenAI-compatibele aanbieders zoals [MiniMax](https://platform.minimaxi.com/), die modellen met een grote context bieden (tot 204K tokens). Zie de [Cursusinstellingen](./00-course-setup/README.md) voor configuratiedetails.

Voor meer informatie over het uitvoeren van de code voor deze cursus, ga naar de [Cursusinstellingen](./00-course-setup/README.md).

## 🙏 Wil je helpen?

Heb je suggesties of spelling- of codefouten gevonden? [Open een issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) of [Maak een pull request aan](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- Python codevoorbeelden met Microsoft Agent Framework met Azure AI Foundry
...
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|---------------------------------------------------------------------------------------|
| Introductie tot AI-agenten en gebruikssituaties | [Link](./01-intro-to-ai-agents/README.md)          | [Video](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Verkennen van AI-agentframeworks             | [Link](./02-explore-agentic-frameworks/README.md)  | [Video](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Begrijpen van AI-agentontwerppatronen        | [Link](./03-agentic-design-patterns/README.md)     | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Ontwerppatroon voor het gebruik van tools    | [Link](./04-tool-use/README.md)                    | [Video](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Agentic RAG                                  | [Link](./05-agentic-rag/README.md)                 | [Video](https://youtu.be/WcjAARvdL7I?si=gKPWsQpKiIlDH9A3)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Vertrouwenswaardige AI-agenten bouwen        | [Link](./06-building-trustworthy-agents/README.md) | [Video](https://youtu.be/iZKkMEGBCUQ?si=jZjpiMnGFOE9L8OK ) | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Ontwerppatroon voor planning                  | [Link](./07-planning-design/README.md)             | [Video](https://youtu.be/kPfJ2BrBCMY?si=6SC_iv_E5-mzucnC)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Multi-agentontwerppatroon                      | [Link](./08-multi-agent/README.md)                 | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Metacognition Ontwerp Patroon                | [Link](./09-metacognition/README.md)               | [Video](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Gebruik van Agentische Protocollen (MCP, A2A en NLWeb) | [Link](./11-agentic-protocols/README.md)           | [Video](https://youtu.be/X-Dh9R3Opn8)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Beheer van Agentisch Geheugen                 | [Link](./13-agent-memory/README.md)     |      [Video](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| Verkenning van Microsoft Agent Framework     | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Bouwen van Computergebruik Agenten (CUA)     | [Link](./15-browser-use/README.md)     |                                                            | [Link](https://docs.browser-use.com/examples/templates/playwright-integration)         |
| Schaalbare Agenten Implementeren             | Binnenkort Beschikbaar                            |                                                            |                                                                                        |
| Lokale AI Agenten Creëren                     | Binnenkort Beschikbaar                               |                                                            |                                                                                        |
| Beveiligen van AI Agenten                     | [Link](./18-securing-ai-agents/README.md)  |                                                            | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
[![AI Agenten voor Beginners](https://img.shields.io/badge/AI%20Agenten%20voor%20Beginners-00C49A?style=for-the-badge&labelColor=E5E7EB&color=00C49A)](https://github.com/microsoft/ai-agents-for-beginners?WT.mc_id=academic-105485-koreyst)
...
### Copilot Serie
[![Copilot voor AI Gesprekken Programmeren](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
Dank aan [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) voor het aanleveren van belangrijke codevoorbeelden die Agentic RAG demonstreren. 

## Bijdragen

Dit project verwelkomt bijdragen en suggesties. De meeste bijdragen vereisen dat je akkoord gaat met een
Contributor License Agreement (CLA) waarin wordt verklaard dat je het recht hebt en daadwerkelijk aan ons
...
CLA moet verstrekken en de PR passend decoreren (bijv. statuscontrole, commentaar). Volg simpelweg de instructies
...
neem contact op met [opencode@microsoft.com](mailto:opencode@microsoft.com) voor bijkomende vragen of opmerkingen.

## Handelsmerken

Dit project kan handelsmerken of logo's bevatten voor projecten, producten of diensten. Gerechtigde gebruik van Microsoft
handelsmerken of logo's is onderworpen aan en moet voldoen aan
[Microsoft's Handelsmerk- en Merkrichtlijnen](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Gebruik van Microsoft handelsmerken of logo's in aangepaste versies van dit project mag geen verwarring zaaien of Microsoft-sponsoring suggereren.
