...
>
> Dette depotet inkluderer over 50 språklige oversettelser som øker nedlastingsstørrelsen betydelig. For å klone uten oversettelser, bruk sparsjekontroller:
>
> **Bash / macOS / Linux:**
> ```bash
...
Hvis dette er din første gang du bygger med generative AI-modeller, sjekk ut vårt [Generative AI For Beginners](https://aka.ms/genai-beginners)-kurs, som inkluderer 21 leksjoner om å bygge med GenAI.
...
Hver leksjon i dette kurset inkluderer kodeeksempler, som du finner i mappen code_samples. Du kan [forke dette depotet](https://github.com/microsoft/ai-agents-for-beginners/fork) for å lage din egen kopi.
...
Dette kurset bruker følgende AI-agentrammeverk og tjenester fra Microsoft:

- [Microsoft Agent Framework (MAF)](https://aka.ms/ai-agents-beginners/agent-framework)
- [Azure AI Foundry Agent Service V2](https://aka.ms/ai-agents-beginners/ai-agent-service)

Noen kodeeksempler støtter også alternative OpenAI-kompatible tilbydere som [MiniMax](https://platform.minimaxi.com/), som tilbyr stor-konteksts-modeller (opptil 204K tokens). Se [Course Setup](./00-course-setup/README.md) for konfigurasjonsdetaljer.

For mer informasjon om å kjøre koden for dette kurset, gå til [Course Setup](./00-course-setup/README.md).

## 🙏 Vil du hjelpe?

Har du forslag eller funnet stave- eller kodefeil? [Opprett en sak](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) eller [Lag en pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Introduksjon til AI-agenter og agentbruk     | [Link](./01-intro-to-ai-agents/README.md)          | [Video](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Verktøy-bruk designmønster                     | [Link](./04-tool-use/README.md)                    | [Video](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Håndtering av agentisk hukommelse                      | [Link](./13-agent-memory/README.md)     |      [Video](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| Utforske Microsoft Agent Framework                         | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Bygge databrukere agenter (CUA)           | [Link](./15-browser-use/README.md)     |                                                            | [Link](https://docs.browser-use.com/examples/templates/playwright-integration)         |
...
### Copilot-serie
[![Copilot for AI-sammenprogrammering](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
Bidragsyteravtale (CLA) som erklærer at du har rett til, og faktisk gir oss
rettighetene til å bruke ditt bidrag. For detaljer, besøk <https://cla.opensource.microsoft.com>.

Når du sender inn en pull-forespørsel, vil en CLA-bot automatisk avgjøre om du må levere
en CLA og merke PR-en passende (f.eks. status-sjekk, kommentar). Følg bare instruksjonene
som boten gir. Du trenger bare gjøre dette en gang for alle repoer som bruker vår CLA.

Dette prosjektet har tatt i bruk [Microsofts retningslinjer for åpen kildekode](https://opensource.microsoft.com/codeofconduct/).
For mer informasjon, se [Retningslinjer for oppførsel FAQ](https://opensource.microsoft.com/codeofconduct/faq/) eller
...
Bruk av Microsoft varemerker eller logoer i modifiserte versjoner av dette prosjektet må ikke skape forvirring eller antyde sponsing fra Microsoft.
