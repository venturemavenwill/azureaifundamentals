...
![Agentes de IA para Iniciantes](../../translated_images/pt-BR/repo-thumbnailv3.917487e234b90100.webp)
...
**Se desejar que línguas adicionais sejam suportadas para tradução, elas estão listadas [aqui](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md).**
...
Este curso possui aulas que cobrem os fundamentos para construir Agentes de IA. Cada aula aborda seu próprio tópico, portanto, comece de onde quiser!

Há suporte multilíngue para este curso. Vá para [línguas disponíveis aqui](#-multi-language-support). 

Se esta é sua primeira vez construindo com modelos de IA Generativa, confira nosso curso [IA Generativa para Iniciantes](https://aka.ms/genai-beginners), que inclui 21 aulas sobre construção com GenAI.

Não se esqueça de [dar uma estrela (🌟) neste repositório](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) e de [bifurcar este repositório](https://github.com/microsoft/ai-agents-for-beginners/fork) para executar o código.

### Conheça Outros Estudantes, Tire Suas Dúvidas

Se você ficar preso ou tiver qualquer dúvida sobre como construir Agentes de IA, junte-se ao nosso canal dedicado no Discord pelo [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### O que você precisa 

Cada aula deste curso inclui exemplos de código, que podem ser encontrados na pasta code_samples. Você pode [bifurcar este repositório](https://github.com/microsoft/ai-agents-for-beginners/fork) para criar sua própria cópia.  

Os exemplos de código nesses exercícios utilizam o Microsoft Agent Framework com o Microsoft Foundry Agent Service V2:
...
Alguns exemplos de código também suportam provedores alternativos compatíveis com OpenAI, como [MiniMax](https://platform.minimaxi.com/), que oferece modelos com contexts grandes (até 204K tokens). Veja os detalhes de configuração em [Configuração do Curso](./00-course-setup/README.md).

Para mais informações sobre como executar o código deste curso, vá para [Configuração do Curso](./00-course-setup/README.md).

## 🙏 Quer ajudar?

Você tem sugestões ou encontrou erros de grafia ou no código? [Abra uma issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) ou [crie um pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- Exemplos de código Python usando Microsoft Agent Framework com Microsoft Foundry
...
| Explorando Frameworks Agentic               | [Link](./02-explore-agentic-frameworks/README.md)  | [Vídeo](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Entendendo Padrões de Design Agentic        | [Link](./03-agentic-design-patterns/README.md)     | [Vídeo](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Implantando Agentes Escaláveis              | [Link](./16-deploying-scalable-agents/README.md) |                                                    | [Link](https://learn.microsoft.com/azure/ai-foundry/agents/overview)                   |
| Criando Agentes de IA Locais                | [Link](./17-creating-local-ai-agents/README.md)  |                                                    | [Link](https://learn.microsoft.com/azure/ai-foundry/foundry-local/)                    |
| Protegendo Agentes de IA                    | [Link](./18-securing-ai-agents/README.md)  |                                                            | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Agradecimentos a [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) por contribuir com exemplos importantes de código demonstrando RAG Agente.
...
Quando você submeter um pull request, um bot de CLA determinará automaticamente se você precisa fornecer
...
[Diretrizes de Marca e Trademark da Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
O uso das marcas ou logotipos da Microsoft em versões modificadas deste projeto não deve causar confusão ou implicar patrocínio da Microsoft.
Qualquer uso das marcas ou logotipos de terceiros está sujeito às políticas desses terceiros.

## Obtendo Ajuda


Se você ficar travado ou tiver dúvidas sobre como construir aplicativos de IA, junte-se a:

[![Microsoft Foundry Discord](https://img.shields.io/badge/Discord-Azure_AI_Foundry_Community_Discord-blue?style=for-the-badge&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)

Se você tiver comentários sobre produtos ou erros durante a construção, visite:
