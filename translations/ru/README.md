...
![Агенты ИИ для начинающих](../../translated_images/ru/repo-thumbnailv3.917487e234b90100.webp)

## Курс, который обучит всему, что нужно знать, чтобы начать создавать агентов ИИ
...
>
> Этот репозиторий включает более 50 языковых переводов, что значительно увеличивает размер загрузки. Чтобы клонировать без переводов, используйте частичную загрузку:
>
> **Bash / macOS / Linux:**
> ```bash
...
**Если вы хотите добавить поддержку дополнительных языков перевода, их список доступен [здесь](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md).**
...
В этом курсе есть уроки, охватывающие основы создания агентов ИИ. Каждый урок посвящен своей теме, так что начинайте с любого!

Этот курс поддерживает несколько языков. Посетите наш раздел с [доступными языками здесь](#-multi-language-support).

Если вы впервые работаете с генеративными моделями ИИ, посмотрите наш курс [Генеративный ИИ для начинающих](https://aka.ms/genai-beginners), включающий 21 урок по работе с GenAI.

Не забудьте [поставить звезду (🌟) этому репозиторию](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) и [форкнуть репозиторий](https://github.com/microsoft/ai-agents-for-beginners/fork), чтобы запустить код.

### Познакомьтесь с другими обучающимися, получите ответы на свои вопросы

Если вы застряли или у вас есть вопросы по созданию агентов ИИ, присоединяйтесь к нашему специализированному Discord-каналу в [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Что вам нужно

В каждом уроке этого курса есть примеры кода, которые находятся в папке code_samples. Вы можете [форкнуть этот репозиторий](https://github.com/microsoft/ai-agents-for-beginners/fork), чтобы создать свою копию.

Примеры кода в этих упражнениях используют Microsoft Agent Framework с Microsoft Foundry Agent Service V2:

- [Microsoft Foundry](https://aka.ms/ai-agents-beginners/ai-foundry) - Требуется учетная запись Azure

В этом курсе используются следующие фреймворки и сервисы агентов ИИ от Microsoft:

- [Microsoft Agent Framework (MAF)](https://aka.ms/ai-agents-beginners/agent-framework)
- [Microsoft Foundry Agent Service V2](https://aka.ms/ai-agents-beginners/ai-agent-service)

Некоторые примеры кода также поддерживают альтернативных провайдеров, совместимых с OpenAI, таких как [MiniMax](https://platform.minimaxi.com/), который предлагает модели с большим контекстом (до 204K токенов). См. [Настройку курса](./00-course-setup/README.md) для деталей конфигурации.
...
- Примеры кода на Python с использованием Microsoft Agent Framework и Microsoft Foundry
...
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Введение в агентов ИИ и случаи их использования       | [Ссылка](./01-intro-to-ai-agents/README.md)          | [Видео](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Ссылка](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Изучение агентских фреймворков              | [Ссылка](./02-explore-agentic-frameworks/README.md)  | [Видео](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Ссылка](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Создание надежных агентов ИИ               | [Ссылка](./06-building-trustworthy-agents/README.md) | [Видео](https://youtu.be/iZKkMEGBCUQ?si=jZjpiMnGFOE9L8OK ) | [Ссылка](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Паттерн проектирования мультиагентных систем                   | [Ссылка](./08-multi-agent/README.md)                 | [Видео](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Ссылка](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Метапознание паттерн дизайна                 | [Link](./09-metacognition/README.md)               | [Video](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Искусственные агенты в производстве                      | [Link](./10-ai-agents-production/README.md)        | [Video](https://youtu.be/l4TP6IyJxmQ?si=31dnhexRo6yLRJDl)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Использование агентских протоколов (MCP, A2A и NLWeb) | [Link](./11-agentic-protocols/README.md)           | [Video](https://youtu.be/X-Dh9R3Opn8)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Инжиниринг контекста для искусственных агентов            | [Link](./12-context-engineering/README.md)         | [Video](https://youtu.be/F5zqRV7gEag)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Управление агентскими воспоминаниями                      | [Link](./13-agent-memory/README.md)     |      [Video](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| Изучение Microsoft Agent Framework                         | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Создание агентов для использования компьютера (CUA)           | [Link](./15-browser-use/README.md)     |                                                            | [Link](https://docs.browser-use.com/examples/templates/playwright-integration)         |
| Развертывание масштабируемых агентов                    | [Link](./16-deploying-scalable-agents/README.md) |                                                    | [Link](https://learn.microsoft.com/azure/ai-foundry/agents/overview)                   |
| Создание локальных искусственных агентов                     | [Link](./17-creating-local-ai-agents/README.md)  |                                                    | [Link](https://learn.microsoft.com/azure/ai-foundry/foundry-local/)                    |
| Защита искусственных агентов                           | [Link](./18-securing-ai-agents/README.md)  |                                                            | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
[![Искусственные агенты для начинающих](https://img.shields.io/badge/AI%20Agents%20for%20Beginners-00C49A?style=for-the-badge&labelColor=E5E7EB&color=00C49A)](https://github.com/microsoft/ai-agents-for-beginners?WT.mc_id=academic-105485-koreyst)
...
Спасибо [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) за вклад важных примеров кода, демонстрирующих Agentic RAG. 
...
права использовать ваш вклад. Для подробностей посетите <https://cla.opensource.microsoft.com>.

При создании pull request CLA-бот автоматически определит, нужно ли предоставлять
CLA и оформит PR соответствующим образом (например, проверка статуса, комментарий). Просто следуйте инструкциям,
предоставленным ботом. Это нужно сделать только один раз для всех репозиториев, использующих нашу CLA.

Этот проект придерживается [Кодекса поведения с открытым исходным кодом Microsoft](https://opensource.microsoft.com/codeofconduct/).
Подробнее смотрите [FAQ по Кодексу поведения](https://opensource.microsoft.com/codeofconduct/faq/) или
свяжитесь по адресу [opencode@microsoft.com](mailto:opencode@microsoft.com) для дополнительных вопросов или комментариев.

## Торговые марки

Этот проект может содержать торговые марки или логотипы проектов, продуктов или услуг. Авторизованное использование торговых марок или логотипов Microsoft
...
Использование торговых марок или логотипов Microsoft в измененных версиях этого проекта не должно вызывать путаницу или подразумевать спонсорство Microsoft.
Любое использование торговых марок или логотипов третьих сторон регулируется политиками этих третьих сторон.

## Получение помощи


Если вы застряли или у вас есть вопросы по созданию ИИ-приложений, присоединяйтесь:
